...
// @author Mauricio de Garay <mauriciodg2000@gmail.com>
#include <stdio.h>
#include <stdlib.h>
#include <string.h>
#include <ctype.h>
...
/*
* La función utilitiesValidarEntero  se encarga de  validar si un numero es 
* entero (no tiene ningún valor después del punto decimal)
*
*
* @param float numero: un numero flotante.
* 
*
* @return int 0 (FALSE) si no es entero, 1 (TRUE) si sí es entero.
*
*
*/
